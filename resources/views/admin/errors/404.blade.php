...
<head><base href="../../../">
    ...
    <link href="{{ asset('/adminAssets/css/pages/error/error-6.'.direction('.').'css') }}" rel="stylesheet" type="text/css"/>
...
<div class="d-flex flex-column flex-root">
    <!--begin::Error-->
    <div class="error error-6 d-flex flex-row-fluid bgi-size-cover bgi-position-center" style="background-image: url({{ asset('adminAssets/media/error/bg6.jpg') }});">
        <!--begin::Content-->
        <div class="d-flex flex-column flex-row-fluid text-center">
            <h1 class="error-title font-weight-boldest text-white mb-12" style="margin-top: 12rem;">{{admin('Sorry ...')}}</h1>
            <p class="display-4 font-weight-bold text-white">{{admin('You don`t have access to this page')}}</p>
        </div>
        <!--end::Content-->
    </div>
    <!--end::Error-->
