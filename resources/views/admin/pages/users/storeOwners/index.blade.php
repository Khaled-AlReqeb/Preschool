                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex align-items-baseline mr-5">
                        ...
                        <span class="text-dark-50 font-weight-bold" id="kt_subheader_total">
                              <a class="text-dark"
                                 href="{{route('admin.store_owners.index')}}">{{admin('Stores Owners')}}</a>
                        </span>
                        </div>
                ...
                <div class="card card-custom">
                    <div class="card-header">
                        <div class="card-title">
                            ...
                            <h3 class="card-label">{{admin('Stores Owners')}}</h3>
                        </div>
        ...
        var KTDatatablesExtensionButtons = function () {
            ...
            var initTable1 = function () {
                ...
                table.DataTable({
                    ...
                    "ajax": {
                        url: "{{route('admin.store_owners.load')}}",
                        data: function (d) {
                    ...
                    columnDefs: [
                        {
                            ...
                            render: function (data, type, full, meta) {
                                ...
                                x = x + '<a href="/admintz/stores/edit/' + full.store_id + '" style="margin:1px;" class="btn btn-sm btn-icon btn-icon-md btn-dark btn-elevate btn-pill btn-elevate-air fa-lg" id="edit_btn"  title="{{admin('Store')}}"><i class="la la-store fa-small"></i></a>';
