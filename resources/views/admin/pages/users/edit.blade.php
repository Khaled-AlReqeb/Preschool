                ...
                <div class="d-flex align-items-center flex-wrap mr-2">
                    ...
                    <div class="d-flex align-items-center mt-2 mb-2 mr-5" id="kt_subheader_search">
                        <span class="text-dark-50 font-weight-bold" id="kt_subheader_total">
                              <a class="text-dark"
                                 href="#">{{admin('Managment Accounts')}}</a>
                        </span>
                    </div>
                    ...
                    <div class="d-flex align-items-center" id="kt_subheader_search">
                        <span class="text-dark-50 font-weight-bold" id="kt_subheader_total">
                            <a class="text-dark"
                               href="{{route('admin.settings.admin_accounts.edit',$data->id)}}">{{admin('Edit')}}</a>
                        </span>
                    </div>
                    <!--end::Search Form-->
                </div>
                                                ...
                                                <div class="col-9">
                                                    <select
                                                        ...
                                                        <option value="{{$data->currency_id}}"
                                                                selected="selected">{{$data->currency->iso}}</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <!--end::Group-->
                                                ...
                                                <div class="col-9">
                                                    <select
                                                        ...
                                                        <option value="{{$data->country_id}}"
                                                                selected="selected">{{$data->country->name}}</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <!--end::Group-->
                                            <div class="form-group row">
                                                ...
                                                <div class="col-9">
                                                    <select
                                                        ...
                                                        id="city_id"
                                                        name="city_id">
                                                        <option value="{{$data->detail->city_id}}"
                                                                selected="selected">{{$data->detail->city->name}}</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <!--end::Group-->
                                                ...
                                                <div class="col-9">
                                                    <select
                                                        ...
                                                        <option value="{{$data->phone_code_id}}"
                                                                selected="selected">{{$data->phoneCode->code}}</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <!--end::Group-->
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-9">
                                                    <span class="switch">
																			<label>
                                                                                <input type="checkbox"
                                                                                       name="status" <?= $data->status == 'active' ? 'checked' : ''?>>
																				<span></span>
																			</label>
																		</span>
                                                </div>
...
@section('scripts')
    ...
    <script>
        ...
        $('#main_language').select2({
            ...
            feedCurrencies();
            feedCountries();
            feedCities($("#country_id").val());
            feedPhoneCodes($("#country_id").val());
                        ...
                        fields: {
                            ...
                            confirm_password: {
                                validators: {
                                    ...
                                    identical: {
                                        compare: function () {
                                            return document.getElementById('edit_form').querySelector('[name="password"]').value;
                                        },
                ...
                $('#save').on('click', function (e) {
                    ...
                    validation.validate().then(function (status) {
                        ...
                        if (status == 'Valid') {
                            ...
                            $.ajax({
                                url: "{{ route('admin.settings.admin_accounts.update') }}",
                                ...
                                success: function (e) {
                                    if (e['result'] == 'ok') {
                                        ...
                                        setTimeout(function () {
                                            $(location).attr('href', '{{route('admin.settings.admin_accounts.index')}}');
                                        }, 1500);
