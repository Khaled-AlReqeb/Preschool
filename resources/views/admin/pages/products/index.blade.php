                ...
                <div class="card card-custom">
                    <div class="card-header">
                        <div class="card-title">
                            ...
                            <h3 class="card-label">{{admin('Products')}}</h3>
                        </div>
                        <div class="card-toolbar ">
                            ...
                            <a href="{{route('admin.products.create')}}"
                                class="btn btn-primary font-weight-bolder ml-1 mr-1">
                                        <span class="svg-icon svg-icon-md">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable " id="kt_datatable"
                            ...
                            <tr>
                                <th>#</th>
                                <th>{{admin('Name')}}</th>
                               @if(app('is_multi_store'))<th>{{admin('Store')}}</th> @endif
            ...
            var initTable1 = function () {
                ...
                table.DataTable({
                    ...
                    columns: [
                        ...
                        @if(app('is_multi_store')){data: 'store_name', "className": "text-center"}, @endif
                        {data: 'category', "className": "text-center", orderable: false,},
                        {data: 'cover', "className": "text-center", orderable: false,},
                    ...
                    columnDefs: [
                        {
                            ...
                            render: function (data, type, full, meta) {
                                var x = '<a href="/admintz/products/edit/' + full.id + '" type="submit" style="margin:1px;" class="btn btn-sm btn-icon btn-icon-md btn-success btn-elevate btn-pill btn-elevate-air la la-edit fa-lg" id="edit_btn" title="{{admin('Edit')}}"></a>';
                                ...
                                if (full.status == 'active') {
                                    ...
                                    x = x + '<button type="submit" style="margin:1px;" class="btn btn-sm btn-icon btn-icon-md btn-primary btn-elevate btn-pill btn-elevate-air la la-check-circle  fa-lg" id="activate_btn" title="{{admin('Active')}}"></button>';
                                }
                                x = x +  '<a href="/admintz/products/'+ full.id +'/attributes" type="submit" style="margin:1px;" class="btn btn-sm btn-icon btn-icon-md btn-info btn-elevate btn-pill btn-elevate-air fab fa-buffer" id="products_attributes" title="{{admin('Product Attributes')}}"></a>';
                        ...
                        },
                        {
                            targets: -3,
                            render: function (data, type, full, meta) {
                                return '<img src="' + data + '" class="kt-img-rounded" style="width: 50px;height: 50px;" />';
                            },
                        },
