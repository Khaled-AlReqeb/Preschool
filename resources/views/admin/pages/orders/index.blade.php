                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex align-items-baseline mr-5">
                        ...
                        <span class="text-dark-50 font-weight-bold" id="kt_subheader_total">
                              <a class="text-dark"
                                 href="{{route('admin.orders.index')}}">{{admin('Orders ')}}</a>
                        </span>
                        </div>
                ...
                <div class="card card-custom">
                    <div class="card-header">
                        <div class="card-title">
                            ...
                            <h3 class="card-label">{{admin('Orders')}}</h3>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable " id="kt_datatable"
                            ...
                            <tr>
                                ...
                                <th>{{admin('Client Name')}}</th>
                                <th>{{admin('Product Image')}}</th>
                                <th>{{admin('Total Price')}}</th>
            ...
            var initTable1 = function () {
                ...
                table.DataTable({
                    ...
                    columns: [
                        ...
                        {data: 'product', "className": "text-center", orderable: false,},
                        {data: 'client', "className": "text-center", orderable: false,},
                    ...
                    columnDefs: [
                        {
                            ...
                            render: function (data, type, full, meta) {
                                var x = '<a  href="/admintz/orders/show/' + full.id + '" type="submit" style="margin:1px;" class="btn btn-sm btn-icon btn-icon-md btn-info btn-elevate btn-pill btn-elevate-air la la-eye fa-lg" id="edit_btn" title="{{admin('View')}}"></a>';
                                ...
                                {{--x = x + '<a  type="submit" href="/admintz/subCategories/' + full.id + '"style="margin:1px;" class="btn btn-sm btn-icon btn-icon-md btn-dark btn-elevate btn-pill btn-elevate-air flaticon2-tag fa-lg" id="details_btn" title="{{admin('Sub Categories')}}"></a>';--}}
