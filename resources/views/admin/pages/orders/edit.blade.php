            ...
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-2">
                    ...
                    <div class="d-flex align-items-center" id="kt_subheader_search">
                        <span class="text-dark-50 font-weight-bold" id="kt_subheader_total">
                              <a class="text-dark" href="{{route('admin.orders.edit',$data->id)}}">{{$data->id}}</a>
                        </span>
                    </div>
                    <!--end::Search Form-->
                </div>
                            ...
                            <form class="form" id="edit_form">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-6">
                                            <label class="">{{admin('Client Name')}}</label>
                                            <span style="color: red;"> * </span>
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="en_name" value="{{$data->client->name}}" disabled>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            ...
                                            <span style="color: red;"> * </span>
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="en_name" value="{{$data->client->email}}" disabled>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            ...
                                            <span style="color: red;"> * </span>
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="en_name" value="{{$data->client->mobile}}" disabled>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <label class="">{{admin('Product Name')}}</label>
                                            <span style="color: red;"> * </span>
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="en_name" value="{{$data->product->name}}" disabled>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <label class="">{{admin('Total Price')}}</label>
                                            <span style="color: red;"> * </span>
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="en_name" value="{{$data->price}}" disabled>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <label class="">{{admin('Quantity')}}</label>
                                            <span style="color: red;"> * </span>
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="en_name" value="{{$data->quantity}}" disabled>
                                            </div>
                                        </div>
                                    </div>
                                </div>
