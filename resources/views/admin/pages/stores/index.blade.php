                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex align-items-baseline mr-5">
                        ...
                        <span class="text-dark-50 font-weight-bold" id="kt_subheader_total">
                              <a class="text-dark"
                                 href="{{route('admin.stores.index')}}">{{admin('Stores')}}</a>
                        </span>
                        </div>
                ...
                <div class="card card-custom">
                    <div class="card-header">
                        <div class="card-title">
                            ...
                            <h3 class="card-label">{{admin('stores')}}</h3>
                        </div>
            ...
            var initTable1 = function () {
                ...
                table.DataTable({
                    ...
                    columns: [
                        ...
                        {data: 'store_name', "className": "text-center", orderable: false,},
                    ...
                    columnDefs: [
                        {
                            ...
                            render: function (data, type, full, meta) {
                                var x = '<a  href="/admintz/stores/edit/' + full.id + '" type="submit" style="margin:1px;" class="btn btn-sm btn-icon btn-icon-md btn-success btn-elevate btn-pill btn-elevate-air la la-edit fa-lg" id="edit_btn" title="{{admin('Edit')}}"></a>';
                                x = x + '<a  href="/admintz/stores/product_properties/' + full.id + '" type="submit" style="margin:1px;" class="btn btn-sm btn-icon btn-icon-md btn-dark btn-elevate btn-pill btn-elevate-air flaticon-shapes fa-lg"  title="{{admin('Product Properties')}}"></a>';
                                {{--x = x + '<a type="submit" href="/admintz/stores/details/' + full.id + '"style="margin:1px;" class="btn btn-sm btn-icon btn-icon-md btn-info btn-elevate btn-pill btn-elevate-air la la-eye fa-lg" id="details_btn" title="{{admin('View')}}"></a>';--}}
                        ...
                        },
                        {
                            targets: -3,
                            render: function (data, type, full, meta) {
                                return '<img src="' + full.logo + '" class="rounded-circle" style="width: 50px;height: 50px;" />';
                            },
                        },
                    ],
                });
