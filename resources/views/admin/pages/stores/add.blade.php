            ...
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-2">
                    ...
                    <div class="d-flex align-items-center" id="kt_subheader_search">
                        <span class="text-dark-50 font-weight-bold" id="kt_subheader_total">
                            <a class="text-dark"
                               href="{{route('admin.stores.create')}}">{{admin('New Record')}}</a>
                        </span>
                    </div>
                </div>
                <!--end::Details-->
                                                ...
                                                <div class="col-xl-7 my-2">
                                                    ...
                                                    <div class="form-group row">
                                                        <label
                                                            ...
                                                            <span style="color: red;"> * </span></label>
                                                        <div class="col-9">
                                                            <input type="text" class="form-control form-control-solid" name="store_mobile" value="">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label
                                                            ...
                                                            <span style="color: red;"> * </span></label>
                                                        <div class="col-9">
                                                            <input type="text" class="form-control form-control-solid" name="store_email" value="">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                            <label
                                                                ...
                                                                <span style="color: red;"> * </span></label>
                                                            <div class="col-9"><textarea class="form-control" name="description" rows="8" cols="150"></textarea>
                                                        </div>
                                                    </div>
                                                    <!--begin::Group-->
                                                    <div class="form-group row">
