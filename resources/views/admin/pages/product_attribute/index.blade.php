                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex align-items-baseline mr-5">
                        ...
                        <span class="text-dark-50 font-weight-bold" id="kt_subheader_total">
                              <a class="text-dark"
                                 href="{{route('admin.product_attributes.index',['product',$product_id])}}">{{admin('Product Attributes ')}}</a>
                        </span>
                        </div>
                ...
                <div class="card card-custom">
                    <div class="card-header">
                        <div class="card-title">
                            ...
                            <h3 class="card-label">{{admin('Product Attributes')}}</h3>
                        </div>
                        <div class="card-toolbar">
                            ...
                            <!--end::Dropdown-->
                            <!--begin::Button-->
                            <a href="{{route('admin.product_attributes.create',['product',$product_id])}}"
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable " id="kt_datatable"
                            ...
                            <tr>
                                <th>#</th>
                                <th>{{admin('Product name')}}</th>
                                <th>{{admin('Attribute name')}}</th>
                                <th>{{admin('value')}}</th>
...
@section('scripts')
        ...
        var KTDatatablesExtensionButtons = function () {
            ...
            var initTable1 = function () {
                ...
                table.DataTable({
                    ...
                    "ajax": {
                        url: "{{route('admin.product_attributes.load',['product',6])}}",
                        data: function (d) {
                    ...
                    columns: [
                        ...
                        {data: 'prodcut_name', "className": "text-center", orderable: false,},
                        {data: 'attribute_name', "className": "text-center", orderable: false,},
                    ...
                    columnDefs: [
                        {
                            ...
                            render: function (data, type, full, meta) {
                                var x = '<a  href="/admintz/products/'+full.product_id+'/attributes/edit/' + full.id + '" type="submit" style="margin:1px;" class="btn btn-sm btn-icon btn-icon-md btn-success btn-elevate btn-pill btn-elevate-air la la-edit fa-lg" id="edit_btn" title="{{admin('Edit')}}"></a>';
                        ...
                        },
                        {
                            targets: -3,
                            render: function (data, type, full, meta) {
                                return '<img src="' + full.flag_image + '" class="rounded-circle" style="width: 50px;height: 50px;" />';
                            },
                        },
                    ],
                });
    ...
    <script>
        ...
        function removeTableRow(id, swal) {
            var table = $('#kt_datatable').DataTable();
            $.ajax({
                url: {{ route('admin.product_attributes.destroy',['product',$product_id]) }},
                type: "post",
                data: {
                    id: id,
                    _token: '{{csrf_token()}}'
        ...
        function disableTableRow(id, swal) {
            var table = $('#kt_datatable').DataTable();
            $.ajax({
                url: "/admintz/product_attributes/disable",
                type: "post",
                data: {
                    id: id,
                    _token: '{{csrf_token()}}'
        ...
        function activateTableRow(id, swal) {
            var table = $('#kt_datatable').DataTable();
            $.ajax({
                url: "/admintz/product_attributes/activate",
                type: "post",
                data: {
                    id: id,
                    _token: '{{csrf_token()}}'
