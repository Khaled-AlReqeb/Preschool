            ...
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-2">
                    ...
                    <div class="d-flex align-items-center" id="kt_subheader_search">
                        <span class="text-dark-50 font-weight-bold" id="kt_subheader_total">
                              <a class="text-dark" href="{{route('admin.attributes.edit',$data->id)}}">{{$data->name}}</a>
                        </span>
                    </div>
                    <!--end::Search Form-->
                </div>
                            ...
                            <form class="form" id="edit_form">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-6">
                                            <label>{{admin('attribute name')}}</label>
                                        ...
                                        <div class="col-lg-6">
                                            <label class="">{{admin('attribute description')}}</label>
                                            <span style="color: red;"> * </span>
                                            <div class="input-group">
                ...
                $('#save').on('click', function (e) {
                    ...
                    validation.validate().then(function(status) {
                        ...
                        if (status == 'Valid') {
                            ...
                            $.ajax({
                                url: "{{ route('admin.attributes.update',$data->id) }}",
                                ...
                                success: function (e) {
                                    if (e['result'] == 'ok') {
                                        ...
                                        setTimeout(function () {
                                            $(location).attr('href', '{{route('admin.attributes.index')}}');
                                        }, 1500);
