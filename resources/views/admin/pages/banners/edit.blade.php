            ...
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-2">
                    ...
                    <div class="d-flex align-items-center" id="kt_subheader_search">
                        <span class="text-dark-50 font-weight-bold" id="kt_subheader_total">
                              <a class="text-dark" href="{{route('admin.banners.edit',$data->id)}}">{{$data->title}}</a>
                        </span>
                    </div>
                    <!--end::Search Form-->
                </div>
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <div class="input-group">
                                                <select
                                                    ...
                                                    name="type">
                                                    <option
                                                        value="external"  <?= $data->type == 'external' ? 'selected' : ''?>>{{admin('External')}}</option>
                                                    <option
                                                        value="internal"  <?= $data->type == 'internal' ? 'selected' : ''?>>{{admin('Internal')}}</option>
                                        ...
                                        <div class="col-lg-4 internal_type d-none">
                                            ...
                                            <span style="color: red;"> * </span>
                                                <select
                                                    ...
                                                    name="route_type">
                                                    <option
                                                        value="product"  <?= $data->route_type == 'product' ? 'selected' : ''?>>{{admin('Product')}}</option>
                                                    <option
                                                        value="category"  <?= $data->route_type == 'category' ? 'selected' : ''?>>{{admin('Category')}}</option>
