                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex align-items-baseline mr-5">
                        ...
                        <span class="text-dark-50 font-weight-bold" id="kt_subheader_total">
                              <a class="text-dark"
                                 href="{{route('admin.settings.currencies.index')}}">{{admin('Currency ')}}</a>
                        </span>
                        </div>
                ...
                <div class="card card-custom">
                    <div class="card-header">
                        <div class="card-title">
                            ...
                            <h3 class="card-label">{{admin('Currencies')}}</h3>
                        </div>
...
@section('scripts')
        ...
        var KTDatatablesExtensionButtons = function () {
            ...
            var initTable1 = function () {
                ...
                table.DataTable({
                    ...
                    "ajax": {
                        url: "{{route('admin.settings.currencies.load')}}",
                        data: function (d) {
                    ...
                    columns: [
                        ...
                        {data: 'change_factor', "className": "text-center", orderable: false,},
                    ...
                    columnDefs: [
                        {
                            ...
                            render: function (data, type, full, meta) {
                                var x = '<a  href="/admintz/settings/currencies/edit/' + full.id + '" type="submit" style="margin:1px;" class="btn btn-sm btn-icon btn-icon-md btn-success btn-elevate btn-pill btn-elevate-air la la-edit fa-lg" id="edit_btn" title="{{admin('Edit')}}"></a>';
    ...
    <script>
        ...
        function removeTableRow(id, swal) {
            var table = $('#kt_datatable').DataTable();
            $.ajax({
                url: "/admintz/settings/currencies/delete",
                type: "post",
                data: {
                    id: id,
                    _token: '{{csrf_token()}}'
        ...
        function disableTableRow(id, swal) {
            var table = $('#kt_datatable').DataTable();
            $.ajax({
                url: "/admintz/settings/currencies/disable",
                type: "post",
                data: {
                    id: id,
                    _token: '{{csrf_token()}}'
        ...
        function activateTableRow(id, swal) {
            var table = $('#kt_datatable').DataTable();
            $.ajax({
                url: "/admintz/settings/currencies/activate",
                type: "post",
                data: {
                    id: id,
                    _token: '{{csrf_token()}}'
