            ...
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-2">
                    ...
                    <div class="d-flex align-items-center" id="kt_subheader_search">
                        <span class="text-dark-50 font-weight-bold" id="kt_subheader_total">
                              <a class="text-dark" href="{{route('admin.settings.currencies.edit',$data->id)}}">{{$data->name}}</a>
                        </span>
                    </div>
                    <!--end::Search Form-->
                </div>
                        ...
                        <div class="card card-custom">
                            ...
                            <form class="form" id="edit_form">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-6">
                                            <label>{{admin('ISO')}}</label>
                                            <span style="color: red;"> * </span>
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="iso" value="{{$data->iso}}">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <label class="">{{admin('Change Factor')}}</label>
                                            <span style="color: red;"> * </span>
                                            <div class="input-group">
                                                <input type="number" class="form-control" name="change_factor"
                                                       min="0.001" step="0.001" value="{{$data->rate->change_factor}}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                    ...
                    document.getElementById('edit_form'),
                    {
                        fields: {
                            ...
                            change_factor: {
                                validators: {
                                    notEmpty: {
                                        message: "{{admin('Change factor is required')}}"
                                    },
                                },
                            },
                ...
                $('#save').on('click', function (e) {
                    ...
                    validation.validate().then(function(status) {
                        ...
                        if (status == 'Valid') {
                            ...
                            $.ajax({
                                url: "{{ route('admin.settings.currencies.update') }}",
                                ...
                                success: function (e) {
                                    if (e['result'] == 'ok') {
                                        ...
                                        setTimeout(function () {
                                            $(location).attr('href', '{{route('admin.settings.currencies.index')}}');
                                        }, 1500);
