            ...
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-2">
                    ...
                    <div class="d-flex align-items-center" id="kt_subheader_search">
                        <span class="text-dark-50 font-weight-bold" id="kt_subheader_total">
                              <a class="text-dark" href="{{route('admin.settings.walkthroughs.edit',$data->id)}}">{{$data->title}}</a>
                        </span>
                    </div>
                    <!--end::Search Form-->
                </div>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-6">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="ar_title" value="{{$data->ar_title}}">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            ...
                                            <span style="color: red;"> * </span>
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="en_title" value="{{$data->en_title}}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-lg-6">
                                            ...
                                            <span style="color: red;"> * </span>
                                            <div class="input-group">
                                                <textarea class="form-control summernote" id="ar_description" name="ar_description" rows="8"
                                                          cols="150">{{$data->ar_description}}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            ...
                                            <span style="color: red;"> * </span>
                                            <div class="input-group">
                                                <textarea class="form-control summernote" id="en_description" name="en_description" rows="8"
                                                          cols="150">{{$data->en_description}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                ...
                $('#save').on('click', function (e) {
                    ...
                    validation.validate().then(function(status) {
                        ...
                        if (status == 'Valid') {
                            ...
                            $.ajax({
                                url: "{{ route('admin.settings.walkthroughs.update') }}",
                                ...
                                success: function (e) {
                                    if (e['result'] == 'ok') {
                                        ...
                                        setTimeout(function () {
                                            $(location).attr('href', '{{route('admin.settings.walkthroughs.index')}}');
                                        }, 1500);
