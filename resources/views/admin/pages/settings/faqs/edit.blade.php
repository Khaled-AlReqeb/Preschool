            ...
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-2">
                    ...
                    <div class="d-flex align-items-center" id="kt_subheader_search">
                        <span class="text-dark-50 font-weight-bold" id="kt_subheader_total">
                              <a class="text-dark" href="{{route('admin.settings.faqs.edit',$data->id)}}">{{$data->name}}</a>
                        </span>
                    </div>
                    <!--end::Search Form-->
                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-6">
                                            ...
                                            <span style="color: red;"> * </span>
                                            <div class="input-group">
                                                <textarea class="form-control summernote" id="ar_value" name="ar_value" rows="8"
                                                          cols="150">{{$data->ar_value}}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            ...
                                            <span style="color: red;"> * </span>
                                            <div class="input-group">
                                                <textarea class="form-control summernote" id="en_value" name="en_value" rows="8"
                                                          cols="150">{{$data->en_value}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                ...
                $('#save').on('click', function (e) {
                    ...
                    validation.validate().then(function(status) {
                        ...
                        if (status == 'Valid') {
                            ...
                            $.ajax({
                                url: "{{ route('admin.settings.faqs.update') }}",
                                ...
                                success: function (e) {
                                    if (e['result'] == 'ok') {
                                        ...
                                        setTimeout(function () {
                                            $(location).attr('href', '{{route('admin.settings.faqs.index')}}');
                                        }, 1500);
