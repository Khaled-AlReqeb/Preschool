            ...
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-2">
                    ...
                    <div class="d-flex align-items-center" id="kt_subheader_search">
                        <span class="text-dark-50 font-weight-bold" id="kt_subheader_total">
                              <a class="text-dark" href="{{route('admin.categories.edit',$data->id)}}">{{$data->name}}</a>
                        </span>
                    </div>
                    <!--end::Search Form-->
                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6" hidden>
                                            <label>{{admin('Store Name')}}</label>
                                            <span style="color: red;"> * </span>
                                            <div class="input-group">
                                                @if(auth('admin')->user()->role_id == 3)
                                                    <input type="text" class="form-control" value="{{ auth('admin')->user()->store->id }}" name="store_id">
                                                @else
                                                    <input type="text" class="form-control" value="0" name="store_id">
                                                @endif                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                            ...
                            $.ajax({
                                ...
                                success: function (e) {
                                    if (e['result'] == 'ok') {
                                        ...
                                        setTimeout(function () {
                                            $(location).attr('href', '{{route('admin.categories.index')}}');
                                        }, 1500);
