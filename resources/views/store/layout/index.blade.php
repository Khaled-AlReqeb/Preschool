...
<head>
    ...
    <link rel="icon" href="{{url(webaAssets('store'))}}/images/favicon/1.png" type="image/x-icon">
    <link rel="shortcut icon" href="{{url(webaAssets('store'))}}/images/favicon/1.png" type="image/x-icon">
                    ...
                    <div class="main-menu">
                        <div class="menu-left">
                            ...
                            <div class="brand-logo">
                                <a href="index.html"><img src="{{url(webaAssets('store'))}}/images/icon/logo.png"
                                ...
                                <div class="icon-nav d-none d-sm-block">
                                    <ul>
                                        <li class="onhover-div mobile-search">
                                            <div><img src="{{url(webaAssets('store'))}}/images/icon/search.png" onclick="openSearch()"
                                                      class="img-fluid blur-up lazyload" alt=""> <i class="ti-search"
                                                                                                    onclick="openSearch()"></i></div>
                                        </li>
                                        <li class="onhover-div mobile-setting">
                                            <div><img src="{{url(webaAssets('store'))}}/images/icon/setting.png"
                                                      class="img-fluid blur-up lazyload" alt=""> <i
                                                    class="ti-settings"></i></div>
                                        </li>
                                        <li class="onhover-div mobile-cart">
                                            <div><img src="{{url(webaAssets('store'))}}/images/icon/cart.png"
                                                      class="img-fluid blur-up lazyload" alt=""> <i
...
{{--                                <div class="offer-content"> <img src="{{url(webaAssets('store'))}}/images/Offer-banner.png"--}}
...
{{--                        <div class="quick-view-img"><img src="{{url(webaAssets('store'))}}/images/pro3/1.jpg" alt=""--}}
        ...
        <div class="setting-body">
            ...
            <div class="buy_btn">
                ...
                <a href="https://themeforest.net/item/multikart-responsive-angular-ecommerce-template/22905358?s_rank=3"
                   target="_blank" class="btn btn-block purchase_btn"><img src="{{url(webaAssets('store'))}}/images/icon/angular.png"
                ...
                <a href="https://themeforest.net/item/multikart-responsive-react-ecommerce-template/23067773?s_rank=2"
                   target="_blank" class="btn btn-block purchase_btn"><img src="{{url(webaAssets('store'))}}/images/icon/react.png"
                ...
                <a href="https://themeforest.net/item/multikart-multipurpose-shopify-sections-theme/23093831?s_rank=1"
                   target="_blank" class="btn btn-block purchase_btn"><img src="{{url(webaAssets('store'))}}/images/icon/shopify.png"
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="modal-bg">
                                ...
                                <div class="media">
                                    <img src="{{url(webaAssets('store'))}}/images/stop.png"
