                    ...
                    <ul class="header-dropdown">
                        ...
                        <li class="onhover-dropdown mobile-account"> <i class="fa fa-user" aria-hidden="true"></i>
                            ...
                            <ul class="onhover-show-div">
                                @if(auth()->guard('client')->id() != '')
                                @else
                                    <li><a href="{{ url('store/login') }}" data-lng="en">Login</a></li>
                                @endif
                                @if(auth()->guard('client')->id() != '')
                                <li>
                                    <a data-lng="es" href="javascript:;"
                                       onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Logout</a>

                                    <form id="logout-form" action="{{ url('store/logout') }}" method="POST"
                                          style="display: none;">
                                        {{ csrf_field() }}
                                    </form>
                                </li>
                ...
                <div class="main-menu">
                    <div class="menu-left">
                                                    ...
                                                    <div class="row m-0">
                                                        ...
                                                        <div class="col-xl-4">
                                                            <a href="#" class="mega-menu-banner"><img
                                                                    src="{{url(webaAssets('store'))}}/images/mega-menu/fashion.jpg"
                        ...
                        <div class="brand-logo">
                            <a href="{{ url('/store/index') }}"><img src="{{url(webaAssets('store'))}}/images/icon/logo.png"
...
{{--                                                    @if(strtolower($oneStore->store_name) == $store)--}}

{{--                                                    <?php--}}
{{--                                                    $categories = \App\Model\Category::where('store_id', '=', $oneStore->id)->get();--}}
{{--                                                    ?>--}}
{{--                                                    @foreach($categories as $category)--}}
{{--                                                        <li><a href="{{ url('/store/category/'.$category->id) }}">{{ $category->en_name }}</a></li>--}}
{{--                                                    @endforeach--}}
{{--                                                        --}}
{{--                                                @endif--}}
{{--                                            @endforeach--}}
...
{{--                                                    <li><a target="_blank" href="{{ url('/store/category/'.$subCategory->id) }}">{{ $subCategory->en_name }}</a>--}}
{{--                                                    </li>--}}
                                            ...
                                            <li>
                                                <div class="media">
                                                    <a href="#"><img alt="" class="mr-3"
                                                                     src="{{ $details['cover'] }}" style="width: 100px"></a>
                                                    <div class="media-body">
                                                        <a href="#">
                                                            <h4>{{ $details['en_name'] }}</h4>
                                                        </a>
                                                        <h4><span>{{ $details['quantity'] }} x $ {{ $details['price'] }}</span></h4>
                                                    </div>
                                                </div>
...
{{--                                                                                         aria-hidden="true"></i></a></div>--}}
                                            ...
                                            <li>
                                                <div class="buttons"><a href="{{ route('store.cart') }}" class="view-cart">view
                                                        cart</a>
